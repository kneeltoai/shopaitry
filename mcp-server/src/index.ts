...
server.tool(
  'delete_board',
  '보드를 삭제합니다. 보드 내 아이템은 보드 미지정 상태로 유지됩니다.',
  {
...
server.tool(
  'list_items',
  '아이템 목록을 조회합니다. board_id를 지정하면 해당 보드의 아이템만 반환합니다.',
  {
...
server.tool(
  'add_item',
  'URL을 Shopaitry 위시보드에 저장합니다. URL만 넣으면 제목·이미지·가격을 자동으로 추출합니다.',
  {
...
server.tool(
  'update_item',
  '아이템 정보를 수정합니다. 상태(wish/to_buy/bought), 제목, 가격을 변경할 수 있습니다.',
  {
